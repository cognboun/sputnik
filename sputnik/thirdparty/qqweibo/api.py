...
from sputnik.thirdparty.qqweibo.binder import bind_api
from sputnik.thirdparty.qqweibo.error import QWeiboError
from sputnik.thirdparty.qqweibo.parsers import ModelParser
from sputnik.thirdparty.qqweibo.utils import convert_to_utf8_bytes
...
class API(object):
    ...
    def __init__(self, auth_handler=None, retry_count=0,
                 host='openapi.qzone.qq.com', api_root='/api', cache=None,
